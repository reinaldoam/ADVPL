...
aLay[25] := "|                                                                                                                                      |"
aLay[26] := "+--------------------------------------------------------------------------------------------------------------------------------------+"
aLay[27] := "|                                        NAO E DOCUMENTO FISCAL - EXIJA O DOCUMENTO FISCAL                                             |"
aLay[28] := "+--------------------------------------------------------------------------------------------------------------------------------------+"
aLay[29] := "                                                                                                                                        "
aLay[30] := "Data : ########### - Hora : ########                                                                                                    " 
aLay[31] := "                                                                                                                                        "
...
//aLay[44] := "                                                                                                                                        " 
aLay[35] := "                                                                                                                                        "
aLay[36] := "NORMAS E CRITERIOS:                                                                                                                     "
aLay[37] := "                                                                                                                                        "
aLay[38] := "A) ORCAMENTOS: Se decorrido 48 horas (dois dias) apos a emissao  do orcamento, e o conserto  nao for autorizado  sera cobrada           "
aLay[39] := "uma permanencia de 1% ao dia sobre o valor do produto. Apos 15 dias, o equipamento  sera  sucateado e  vendido para cobrir os           " 
aLay[40] := "gastos com armazenagem.                                                                                                                 "
aLay[41] := "B) DA CONCLUSAO DOS SERVICOS: Decorridos 15 (quinze) dias, apos a conclusao do servico, e se ocorrer abandono do proprietario           "
aLay[42] := "responsavel, o equipamento sera sucateado e vendido para cobrir os gastos com pecas e mao-de-obra;                                      "
aLay[43] := "C) Todo equipamento em garantia devera acompanhar a Nota Fiscal de compra;                                                              "
aLay[44] := "                                                                                                                                        " 
