...
±±³Programa  ³SCRNFISC ³ Autor ³ Reinaldo Magalhães     ³ Data ³ 02.05.17 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Impressão de orcamento em impressora não fiscal TH         ³±±
...
User Function SCRNFISC(lCallme,cTpOrc)
  ...
  //   Pergunte(cPerg,.T.)
  //Endif
  Processa({ || xPrintRel(lCallMe,cTpOrc),OemToAnsi('Gerando o relatório.')}, OemToAnsi('Aguarde...'))
...
Static Function xPrintRel(lCallMe,cTpOrc)  
  ...
  oPrint:Say(nLin,0010,"Orçamento: " + SL1->L1_NUM+" - "+cTpOrc,oFont10n,,,,0); nLin += 50
