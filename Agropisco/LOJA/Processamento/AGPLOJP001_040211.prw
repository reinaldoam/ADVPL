...
SZ3->Z3_HORAGER := Time()
SZ3->Z3_PRCFIL  := Prc_Fil020(SD1->D1_COD)								//Preco q sera buscado na empresa 020 filial 01.
SZ3->(MsUnLock())
...
@ 85, 120 SAY "Prc. Venda Filial " SIZE 100,7 PIXEL OF oDlg2
...
@ 85, 170 MSGET	oPVendFil  Var nPVendFil 	PICTURE "@E 999,999.99" SIZE 070,07 PIXEL OF oDlg2 WHEN .F.
