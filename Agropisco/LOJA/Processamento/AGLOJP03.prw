...
±±³Programa  ³ AGLOJP03 ³ Autor ³ Reinaldo Magalhães    ³ Data ³ 03/04/17 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Consulta de comissão de vendedores                         ³±±
...
User Function AGLOJP03(lCallMe)
  ...
  Local aSay    := {}
  Local aButton := {}
  Local cTitulo := "Consulta de comissão de vendedores"
...
Static Function GeraCom(lFim,lCallMe)
  ...
  oBrowse := TCBrowse():New( 01 , 01, 455, 156,,{"Codigo","Nome","Peças","Equipamento","Serviço","Locacao","Total"}, {30,100,50,50,50,50,50},oDlg,,,,,{||},,,,,,,.F.,,.T.,,.F.,,, )
...
User Function TFolder(nPosAt,aPeca,aEquip,aServ,aLoca,aNCla)
  ...
  //- Cria a Folder
  aTFolder := { 'Peças', 'Equipamentos', 'Serviços', 'Locacao', 'Não Classificado' }
  ...
  //³ 05-Folder de Não Classificados  ³
