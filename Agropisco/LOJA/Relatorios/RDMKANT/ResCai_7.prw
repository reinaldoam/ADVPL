...
Private cString    := "SL1"
Private nTotal
Private aEntrada:={},aSaida:={}, aDevoluc:={}
...
Static function RunReport(Cabec1,Cabec2,Titulo,nLin)
  Local nOrdem, aCartao, aFatura, cMatriz, nPos, nValor, nTotNotas, cQry,cRecISS,nValISS,nValTot,cBusca, cNomeCli
...
//  SL1->(dbSetOrder(4))  // Filial + Data ECF + PDV + Operado
 ...
 // SE5->(dbSetOrder(1)) // Filial + Data + Banco
  ...
  Do While !TRB->(EOF())
     ...
     AADD(aDevoluc,{TRB->F1_DOC, cNomeCli, TRB->F1_VALBRUT, "01", "DEV./TROCA" }) 
...
Static Function RecFatura(nPos)
  ...
  While !SE1->(Eof()) .and. SE1->(E1_FILIAL+E1_CLIENTE+E1_LOJA+E1_PREFIXO+E1_NUM) == xFilial("SE1")+cBusca
     ...
     If cNat $ "CRED#REDE#VISA#DINE#AMERICAN"
        ...
        ElseIf cCodCartao $ "DINERAVIST#DINERAPRZ" //- Diners
...
Static Function ImpResumo
  ...
  Local nDinheiro,nSangria,nTroco,nSaldo,nDevoluc
  ...
  For i:= 1 to nLen-1
     ...
     If nLin > 55 // Salto de Página. Neste caso o formulario tem 55 linhas...
        ...
        @nLin, 000 PSay "Cliente                Prefixo          Dinheiro          Cheque          Debito           Diner        Redecard            Visa          Boleto         Dep.C/C           Amex            Total  Nota Fisc"
        nLin++
        @nLin, 000 PSay "--------------------  ----------  --------------  --------------  --------------  --------------  --------------  --------------  --------------  --------------  --------------  --------------  ---------"
        nLin++
     Endif
  ...
  //³ Notas de devolução/retorno ³
  //ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
  If nLin > 55 // Salto de Página. Neste caso o formulario tem 55 linhas...
     nLin:= Cabec(Titulo,Cabec1,Cabec2,NomeProg,Tamanho,nTipo) + 1
  Endif   
  @nLin, 000 PSay PADC("ENTRADAS NO PERIODO - DEVOLUCOES / RETORNO",220)
  nLin+=2                                                  
  ...
  For i:= 1 to Len(aSaida)
     ...
     If nLin > 55 // Salto de Página. Neste caso o formulario tem 55 linhas...
        ...
        nLin+=2                                                            
     Endif
     @nLin, 000      PSay aDevoluc[i,2]  Picture "@!"  
     @nLin, Pcol()+2 PSay aDevoluc[i,1]  Picture "@!"
     @nLin, 178      PSay aDevoluc[i,3]  Picture "@( 999,999,999.99"
     nDevoluc += aDevoluc[i,3]
     nLin++                 
  Next
  @ nLin, 000 PSay __PrtThinLine()                    
  nLin++
