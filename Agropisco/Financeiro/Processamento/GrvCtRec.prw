...
If xNil <> Nil .And. !xSE1->(Eof())
   FWrite(xNil,"00 - 01 GRVCTREC - ACHOU REGISTROS."+CHR(13)+CHR(10))
Endif
...
While !xSE1->(Eof()) .And. !TMP0->(Eof()) .And. cFilSE1+cBusca = xSE1->(E1_FILIAL+E1_CLIENTE+E1_LOJA+E1_PREFIXO+E1_NUM)
    ...
    If xNil <> Nil
       FWrite(xNil,"00 - 02 GRVCTREC - PARCELA: "+xSE1->E1_PARCELA+" - TIPO: "+xSE1->E1_TIPO+CHR(13)+CHR(10))
    Endif
...
If xNil <> Nil
   FWrite(xNil,"00 - 03 GRVCTREC - FINALIZOU."+CHR(13)+CHR(10))
Endif
