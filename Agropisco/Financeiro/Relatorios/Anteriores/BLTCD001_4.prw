...
ฑฑณPrograma  ณ BLTCD001 ณ Autor ณ Alidio Ribeiro        ณ Data ณ 13/10/03 ณฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
User Function BLTCD001(lCallMe)
...
Do While !EOF()
	...
	DbSelectArea("SA6")
	//DbSetOrder(1)
	U_MsSetOrder("SA6","A6_FILIAL+A6_COD+A6_AGENCIA+A6_NUMCON")//Incluํdo por Ulisses Jr em 24/04/08 em substitui็ใo a linha acima
	DbSeek(xFilial("SA6")+SE1->E1_PORTADO+SE1->E1_AGEDEP+SE1->E1_CONTA,.T.)
	
	//Posiciona na Arq de Parametros CNAB
	DbSelectArea("SEE")
	//DbSetOrder(1)
	U_MsSetOrder("SEE","EE_FILIAL+EE_CODIGO+EE_AGENCIA+EE_CONTA+EE_SUBCTA")//Incluํdo por Ulisses Jr em 24/04/08 em substitui็ใo a linha acima
	DbSeek(xFilial("SEE")+SE1->(E1_PORTADO+E1_AGEDEP+E1_CONTA),.T.)
	
	//Posiciona o SA1 (Cliente)
	DbSelectArea("SA1")
	//DbSetOrder(1)
    U_MsSetOrder("SA1","A1_FILIAL+A1_COD+A1_LOJA")//Incluํdo por Ulisses Jr em 24/04/08 em substitui็ใo a linha acima
...
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ IMPRESSAO DO BOLETO LASERDO BB   COM CODIGO DE BARRAS      ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso       ณ Especifico para Clientes Microsiga                         ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
oPrint:Say  (nRow2+0725,400 ,"ATษ O VENCIMENTO, PREFERENCIALMENTE NO BANCO DO BRASIL",oFont10)
oPrint:Say  (nRow2+0765,400 ,"APำS O VENCIMENTO, SOMENTE NO BANCO DO BRASIL",oFont10)
...
oPrint:Say  (nRow3+2015,400 ,"ATษ O VENCIMENTO, PREFERENCIALMENTE NO BANCO DO BRASIL",oFont10)
oPrint:Say  (nRow3+2055,400 ,"APำS O VENCIMENTO, SOMENTE NO BANCO DO BRASIL",oFont10)
