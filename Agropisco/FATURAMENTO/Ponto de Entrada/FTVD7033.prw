...
±±³Fun‡…o    ³FTVD7033  ?Autor ?Reinaldo Magalhães    ?Data ?09.07.18 ³±?
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±?
±±³Descri‡…o ?Ponto de entrada para gravação de preço de custo ³±?
±±³no ato da venda                                             ³±?³±?
...
User Function FTVD7033
  Local _lValid := ParamIxb[1]    //.T. = Se está realizando a gravacao de dados
  Local _nTpOp  := ParamIxb[2]    //Opçao do Menu
  Local lRet    := .T.
  Local _cAlias := ALIAS()
