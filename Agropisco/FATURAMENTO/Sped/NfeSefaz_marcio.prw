...
cTipo   := iif(cTipo  == nil, PARAMIXB[1], cTipo)
cSerie  := iif(cSerie == nil, PARAMIXB[3], cSerie)
cNota   := iif(cNota  == nil, PARAMIXB[4], cNota)
cClieFor:= iif(cClieFor == nil, PARAMIXB[5], cClieFor)
cLoja   := iif(cLoja == nil, PARAMIXB[6], cLoja) 
