...
±±ºPrograma  ³AGFATC02  º Autor ³ Reinaldo Magalhães º Data ³  13/07/17   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Cadastro de contatos                                       º±±
±±º          ³                                                            º±±
...
User Function AGFATC02()  
  ...
  //³ Verifica se é chamado pela rotina de inclusão  ³
...
Static Function ChkOrdem(cOrdem)
  ...
  Endif         
  If !lRet
     MsgInfo("Ordem inválida ou já cadastrada !!!","Atenção")
  Endif
Return lRet