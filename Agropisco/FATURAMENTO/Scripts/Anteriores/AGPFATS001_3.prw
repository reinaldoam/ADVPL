...
//	Cabecalho() // Impressão do Cabeçalho da Nota Fiscal.
    ...
    While lImprime
		...
		While nContServ <= Len(vServ) .and. nNumItens < 4
			...
			@ li,017 Psay vServ[nContServ][3]                                 // Descrição do Serviço  // li -> 61
            ...
            If !Empty(vServ[nContServ][6])
				@ li,017 Psay vServ[nContServ][6];li++                            // Observação 2          // li -> 62
				nNumItens++                     
            EndIf
            If !Empty(vServ[nContServ][7])
				@ li,017 Psay vServ[nContServ][7];li++                            // Observação 3          // li -> 63
