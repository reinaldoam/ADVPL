...
±±³Programa  ³ AMWKF17  ³ Autor ³ Reinaldo Magalhães    ³ Data ³ 19/09/17 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Orçamentos de vendas em aberto diario                      ³±±
...
Static Function EnvEmail(aVendas,cEmail)
  ...
  Local nTotal  := 0 
  Local nAtraso := 0 
  Local cTitulo := "Relacao de Orçamentos de Vendas em Aberto no dia " + DTOC(Date())
