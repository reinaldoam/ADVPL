...
±±³Programa  ³ AMWKF15  ³ Autor ³ Reinaldo Magalhães    ³ Data ³ 05/09/17 ³±±
...
User Function AGWKF15
  Local cDtMesIni := '20170717' //- Data de abertura da loja Parque 10
  Local cDtMesFim := Dtos(Date())       
  Local cTitulo   := "Relacao de orçamentos em aberto até o dia " + DTOC(Date())
...
Static Function MontaQry(cDtMesIni,cDtMesFim)
  ...
  cQry += "AND AB3_SRVGRT='1' "
  cQry += "AND AB3_XNOTA = '' "                 
  //cQry += "ORDER BY AB3_SRVGRT,DIAS DESC"
  cQry += "ORDER BY AB3_NUMORC"
